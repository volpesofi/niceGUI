...
def checkCode1 (nQuiz, entry, someNumber, window):  
    x1 = entry.get()
    ...
    if x1 == someNumber :
        ...
        text1 = "Controlla il QUIZ"+ nQuiz + "e prova ancora"
        color1 = "red"
    label1 = tk.Label(window, text= text1, fg=color1, font=("Helvetica", 16))
...
button1 = tk.Button(convas_A, text='CONTROLLO CODICE QUIZ', command = lambda: checkCode1(nQuiz = "1", entry = entry1, someNumber = "314", window = convas_A), fg="black", font=("Helvetica", 10))
